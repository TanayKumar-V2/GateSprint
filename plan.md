...
Returns overall, subject, and topic aggregates scoped to the current user.

### `POST /api/chat/sessions`

Creates a normal session or a source-question session. Validates ownership and source-question visibility.
...
Verify calculations against known fixtures, report the result, then stop and wait.
